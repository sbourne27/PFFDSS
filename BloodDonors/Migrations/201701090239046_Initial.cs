namespace BloodDonors.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        SiteAngle = c.Double(nullable: false),
                ...
                c => new
                    {
                        ...
                        PotentialThawSettlement = c.Double(nullable: false),
                ...
                c => new
                    {
                        ...
                        Borehole_BoreholeID = c.Int(),
                    })
                .PrimaryKey(t => t.BHSampleId)
                .ForeignKey("dbo.Borehole", t => t.Borehole_BoreholeID)
                .Index(t => t.Borehole_BoreholeID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.BHSample", "Borehole_BoreholeID", "dbo.Borehole");
            ...
            DropIndex("dbo.BHSample", new[] { "Borehole_BoreholeID" });
